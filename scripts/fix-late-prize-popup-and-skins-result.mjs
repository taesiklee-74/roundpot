...
// 1) LatestResultSection props for OECD / late boost breakdown.
replaceInLatest(
...
// 2) Replace skins result amount card with total + breakdown.
insertAfterLatest(
...
// 3) Pass page props to LatestResultSection.
replaceInPage(
...
// 4) Calculate late prize offer for the next hole while on latest-result screen.
insertAfterPage(
